	...
	submitTool := Tool{
		...
		Parameters: map[string]interface{}{
			...
			"properties": map[string]interface{}{
				...
				"topRepositories":      map[string]interface{}{"type": "array", "items": map[string]interface{}{"type": "object", "properties": map[string]interface{}{"name": map[string]string{"type": "string"}, "description": map[string]string{"type": "string"}, "language": map[string]string{"type": "string"}, "stars": map[string]string{"type": "integer"}, "forks": map[string]string{"type": "integer"}, "is_fork": map[string]string{"type": "boolean"}}, "required": []string{"name", "description", "language", "stars", "forks", "is_fork"}, "additionalProperties": false}},
				"contributionGraph":    map[string]interface{}{"type": "object", "properties": map[string]interface{}{"total_contributions": map[string]string{"type": "integer"}, "streak": map[string]string{"type": "integer"}, "contributions": map[string]interface{}{"type": "object", "additionalProperties": map[string]string{"type": "integer"}}}, "required": []string{"total_contributions", "streak"}, "additionalProperties": false},
